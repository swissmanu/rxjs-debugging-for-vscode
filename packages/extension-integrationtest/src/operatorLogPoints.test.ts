...
describe('RxJS Debugging for vscode', () => {
  test('shows operator life cycle events as text editor decoration when using runtime-nodejs', async () => {
    const uri = vscode.Uri.file('/Users/mal/git/private/mse-master-thesis/debugger/packages/testbench-nodejs');
  ...
  // test('shows operator life cycle events as text editor decoration when using runtime-webpack', async () => {
  //   const uri = vscode.Uri.file('/Users/mal/git/private/mse-master-thesis/debugger/packages/testbench-webpack');
  //   await vscode.commands.executeCommand('vscode.openFolder', uri);
  ...
  //   });
  //   // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  //   await vscode.debug.startDebugging(vscode.workspace.workspaceFolders![0], 'Launch Browser');
  //   await debuggingDone;
